							...
							<div class="modal-dialog">
								<div class="modal-content">
									...
									<div class="modal-header">
										<h4 class="modal-title">Print Enrolled Students</h4>
									...
									<div class="modal-body">
										...
										<div class="mb-3">
											<label class="form-label">Search Student (First / Last Name)</label>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <div>
										<button class="btn btn-info btn-md" data-bs-toggle="modal" data-bs-target="#add-modal">
											Add Enrolled Student
										</button>

										<button class="btn btn-primary btn-md" data-bs-toggle="modal" data-bs-target="#standard-modal">
											Import Enrolled Student
										</button>

										<button class="btn btn-danger btn-md" data-bs-toggle="modal" data-bs-target="#printModal">
											Print as PDF
										</button>
										</div>
...
function printAll() {
    ...
    document.body.innerHTML = `
        <html>
            ...
            <body>
                <h2 style="text-align:center;">Enrolled Students List</h2>
                ${printContents}
            </body>
        </html>
    `;
